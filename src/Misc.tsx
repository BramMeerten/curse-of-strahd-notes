...
export const Misc = () => {
    return (
        <React.Fragment>
            ...
            <ul>
                <li>Vampieren kunnen niet tegen:</li>
                <ul>
                    <li>Vampier kan geen huis binnen zonder uitnodiging   (zegt Ismark)</li>
                    <li>Kan niet tegen lopend water en zonlicht                   (zegt Ismark)</li>
                    <li>Stake through heart</li>
                </ul>
