...
export const Quests = () => {
    return (
        <ol>
            <li>Madam Eva:</li>
            <ul>
                <li>[Bescherming] Krachtig voorwerp, the treasure lies in the dragon’s house. In hands once clean, now corrupted. → Licht van
                    Arganas
                </li>
                <li>[Macht]: I see a faceless god, he awaits you at the end of a long and winding road deep in the mountains</li>
            </ul>
            <li>Madam Eva aan Gilliam:</li>
            <ul>
                <li>In dit land is niet alleen rijkdom te vinden, maar ook grote kennis en verhalen. Kijk naar de berg Ghakis.</li>
            </ul>
            <li>Madam Eva aan David:</li>
            <ul>
            ...
            <li>Valenta doden wanneer bom onder koets ontploft</li>
            ...
            <li>Begeleid party vanuit Krezk naar Valaki om bruidsjurk te laten maken</li>
            <li>Laat wapens met zilver maken in Vallaki</li>
            <li>Dagboek terug opgraven en overschrijven?</li>
